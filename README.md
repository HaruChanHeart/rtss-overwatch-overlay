...
![GUIDE_02](./GUIDE_02.png)

3. **Layouts** 메뉴를 선택하고 **Import** 메뉴를 선택해 줍니다. [Overwatch_Layout.ovx](https://github.com/HaruChanHeart/rtss-overwatch-overlay/releases) 파일을 다운로드하고 불러와 주세요
